...
{
    private const int DefaultDoorWidth = 64;
    private const int DefaultWallThickness = 16;
    ...
    protected override void OnMouseDown(MouseEventArgs e)
    {
        ...
        switch (_tool)
        {
            case EditorTool.Room:
                BeginAreaDraw(EditorTool.Room, world);
                break;
    ...
    private bool TryPlaceWallDoor(Point screenPoint)
    {
        ...
        var doorWidth = Math.Min(DefaultDoorWidth, span);
        ...
        var halfThickness = DefaultWallThickness / 2;
    ...
    private void RecessSharedWall(Sector sector, int edgeIndex, SharedWall wall, int inset)
    {
